...
- [docs/workflows/](docs/workflows/) - step-by-step workflows (update GraphQL model: complete Amplify codegen and verify build before any UX code; then optionally [implementing UX after a model change](docs/workflows/NEW_UX_WITH_GRAPHQL_MODEL.md)). Lambda: edit under amplify/backend/function/&lt;name&gt;/src/, run npm install there if deps changed.
